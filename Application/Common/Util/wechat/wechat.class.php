...
class wechat
{
	...
	public function __construct()
	{
		...
		//获取参数配置
		$siteConfig = include __DIR__ . '/Conf/config.php';
		if($siteConfig['wechat_Token'] && $siteConfig['wechat_AppID'] && $siteConfig['wechat_AppSecret'])
		{
			$this->config['wechat_Token']     = $siteConfig['wechat_Token'];
			$this->config['wechat_AppID']     = $siteConfig['wechat_AppID'];
			$this->config['wechat_AppSecret'] = $siteConfig['wechat_AppSecret'];
			$this->config['wechat_AutoLogin'] = $siteConfig['wechat_AutoLogin'];
		}
		else
		{
